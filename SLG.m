%SLG function
function [PostFaultI, PostFaultV] = SLG(Z12,Z0,faultBus,Zl)
...
%
If_neg = zeros(1,nb)';
If_neg(faultBus) = If1;%all zero except fault current at fault bus
%
If_0 = zeros(1,nb)';
If_0(faultBus) = If1;%all zero except fault current at fault bus
...
fprintf(fileID,'#########################################################################################\n')
fprintf(fileID,'-----------------------------------------------------------------------------------------\n');
fprintf(fileID,'                              SLG Fault Analysis \n');
fprintf(fileID,'-----------------------------------------------------------------------------------------\n');
